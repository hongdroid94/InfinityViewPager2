...
import com.hongdroid.infinityviewpager.adapter.RecyclerPagerAdapter;
 ...
 * 리사이클러 어댑터를 가진 버전
 */
public class RecyclerVersionActivity extends AppCompatActivity {
    ...
    private void setInit() {
        ...
        RecyclerPagerAdapter SetupPagerAdapter = new RecyclerPagerAdapter(this, mSetUpList);
